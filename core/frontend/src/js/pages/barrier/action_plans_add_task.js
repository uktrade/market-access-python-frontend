ma.pages.barrier.action_plans_add_task = function(){
    ...
    new ma.components.ConditionalRadioContent({
        ...
        shouldShow: function( value ){ return ( value === 'SCOPING_AND_RESEARCH' ); }
    });
    ...
    new ma.components.ConditionalRadioContent({
        ...
        shouldShow: function( value ){ return ( value === 'LOBBYING' ); }
    });
    ...
    new ma.components.ConditionalRadioContent({
        ...
        shouldShow: function( value ){ return ( value === 'UNILATERAL_INTERVENTIONS' ); }
    });
    ...
    new ma.components.ConditionalRadioContent({
        ...
        shouldShow: function( value ){ return ( value === 'BILATERAL_ENGAGEMENT' ); }
    });
    ...
    new ma.components.ConditionalRadioContent({
        ...
        shouldShow: function( value ){ return ( value === 'PLURILATERAL_ENGAGEMENT' ); }
    });
    ...
    new ma.components.ConditionalRadioContent({
        ...
        shouldShow: function( value ){ return ( value === 'MULTILATERAL_ENGAGEMENT' ); }
    });
    ...
    new ma.components.ConditionalRadioContent({
        ...
        shouldShow: function( value ){ return ( value === 'EVENT' ); }
    });
    ...
    new ma.components.ConditionalRadioContent({
        ...
        shouldShow: function( value ){ return ( value === 'WHITEHALL_FUNDING_STREAMS' ); }
    });
    ...
    new ma.components.ConditionalRadioContent({
        ...
        shouldShow: function( value ){ return ( value === 'RESOLUTION_NOT_LEAD_BY_DIT' ); }
    });
};
