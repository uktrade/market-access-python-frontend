ma.pages.report.sectorsWizardStep = function () {
    ...
    addSectorButton.addEventListener("click", function () {
        append_sector('id_barrier-sectors-affected-sectors', 'sectors_select', 'sectors_list_display')
    });
    const displayOtherSectorButton = document.getElementById("display-other-sector-button")
    ...
    const toggle_mode = function (mode) {
        ...
        if (mode === 'edit') {
            ...
            let current_sector_list = document.getElementById("id_barrier-sectors-affected-sectors")
            ...
            for (let i = 0; i < selected_list.length; i++) {
                ...
                for (let x = 0; x < sector_list.length; x++) {
                    ...
                    if (option.value == selected_list[i]) {
                        ...
                        remove_link.addEventListener("click", function () {remove_item(option.value)})
    ...
    const remove_item = function (item) {
        ...
        if (current_selected_list.value == ""){
            ...
            console.log("current list :", selected_list)
