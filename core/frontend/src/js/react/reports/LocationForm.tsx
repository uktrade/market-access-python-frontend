...
export const LocationForm = () => {
    ...
    // const [tradingBloc, setTradingBloc] = useState<string>();

    // const [causedByTradingBloc, setCausedByTradingBloc] = useState<string>();
    // const [causedByAdminAreas, setCausedByAdminAreas] = useState<string>();

    // const [selectedAdminAreas, setSelectedAdminAreas] = useState<AdminArea[]>(
    //     []
    // );
    ...
    useEffect(() => {
        // setLocation(data.form_data.location);
        setFormState({
            ...formState,
    ...
    return (
        <div>
                ...
                {/* {selectedAdminAreas.length > 0 && (
                    <div className="govuk-form-group">
                        <RadioInput
                            field={form_fields.trade_direction}
                            value={tradeDirection}
                            onChange={(value) => setTradeDirection(value)}
                        />
                    </div>
                )} */}
