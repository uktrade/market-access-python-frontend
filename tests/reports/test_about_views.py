...
class AboutViewTestCase(ReportsTestCase):
    ...
    def test_about_view_returns_correct_html(self):
        ...
        assert (
            expected_barrier_source_radio_count == bs_options_count
    ...
    def test_about_view_required_fields(self, mock_save):
        ...
        self.assertFormError(
            response, "form", "product", "Enter a product, service or investment"
        )
        self.assertFormError(
            response, "form", "source", "Select how you became aware of the barrier"
        )
