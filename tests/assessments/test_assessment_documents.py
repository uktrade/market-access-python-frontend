...
class AssessmentDocumentsTestCase(MarketAccessTestCase):
    ...
    def test_add_assessment_document_ajax(
        self,
        ...
        with open("tests/files/attachment.jpeg", "rb") as document:
            response = self.client.post(
                reverse(
                    "barriers:add_assessment_document",
        ...
        session_key = f"barrier:{self.barrier['id']}:assessment_documents"
    ...
    @patch("barriers.forms.mixins.DocumentMixin.upload_to_s3")
    @patch("utils.api.client.DocumentsResource.create")
    def test_add_assessment_document_ajax_scan_fail(
        self,
        mock_create_document,
        mock_upload_to_s3,
        mock_complete_upload,
    ...
    @patch("barriers.forms.mixins.DocumentMixin.upload_to_s3")
    @patch("utils.api.client.DocumentsResource.create")
    def test_add_assessment_document_ajax_upload_fail(
        self,
        mock_create_document,
        mock_upload_to_s3,
        mock_complete_upload,
    ...
    def test_cancel_new_assessment_document_ajax(self):
        session_key = f"barrier:{self.barrier['id']}:assessment_documents"
        ...
        self.client.post(
            reverse(
                "barriers:cancel_assessment_document",
                kwargs={"barrier_id": self.barrier["id"]},
            ),
            xhr=True,
        )
    ...
    def test_cancel_edit_assessment_document_ajax(self):
        session_key = f"barrier:{self.barrier['id']}:assessment_documents"
        self.update_session({session_key: [{"id": "1"}]})
    ...
    def test_delete_new_assessment_document_ajax(self):
        document_ids = [
    ...
    def test_delete_edit_assessment_document_ajax(self):
        document_ids = [
            "309d9ef4-4379-4514-ae5f-3399ba7f2ca6",
            "edc71297-93e4-42b1-9d7a-122fbb18a092",
        ]
    ...
    def test_delete_edit_assessment_document_non_ajax(self):
        document_ids = [
            "309d9ef4-4379-4514-ae5f-3399ba7f2ca6",
            "edc71297-93e4-42b1-9d7a-122fbb18a092",
        ]
